...
<center>  
    ...
    <div id="home" runat="server" >
        <form id="form1" runat="server">
            <asp:Image ID="i" runat="server" ImageUrl="PICS\logo.png" Width="350px"  Height="150px"/>
       ...
       <center>&emsp;&emsp;&emsp;&emsp;
        <h1><asp:Label Style="color:#00ccff; margin-left:200px" ID="sizlr" runat="server" Visible="false" /></h1></center>
     ...
     <center>
        <div class="w3-content w3-section" style="max-width:550px" id="pic" runat="server" >
            <br />
            <center>
        <img class="mySlides w3-animate-fading" src="PICS\noodles.jpg"  height="450px" width="550px" >
        <img class="mySlides w3-animate-fading" src="PICS\man.jpg" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\szh_f.JPG" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\rice.PNG" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\chop.PNG" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\schewan-vegetables.jpg" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\choco.jpg" height="450px" width="550px">
        <img class="mySlides w3-animate-fading" src="PICS\manchurian.jpg" height="450px" width="550px" >
         <img class="mySlides w3-animate-fading" src="PICS\c_v.jpg" height="450px" width="550px">
                </center>
        </div>
