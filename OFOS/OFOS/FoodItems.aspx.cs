...
namespace OFOS
{
    public partial class FoodItems : System.Web.UI.Page
    {
        ...
        {
            pic.Visible = false;
            //string constr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Aayushi.Mehta\documents\visual studio 2015\Projects\DemoPro\DemoPro\App_Data\ofos.mdf;Integrated Security=True";
            ...
            try
            {
                ...
                while(reader.Read())
                {
                    string im = "./" + reader["Image_url"].ToString().Trim();
                }*/
