        ...
        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">LogOut</asp:LinkButton>  
            ...
            <div id="calendar" runat="server">
               ...
               &nbsp;<asp:RadioButton ID="rdBtn_regi" runat="server" GroupName="grp" Text="Registered User" Font-Size="Small" Font-Names="Georgia"></asp:RadioButton>
                ...
                <asp:Label ID="status" runat="server" Text="" Visible="true"></asp:Label>
                <br />
            ...
            <div id="details" runat="server" visible="false">
             ...
             PagerStyle-CssClass="gridViewPager" PagerStyle-HorizontalAlign="Center" Width="500px" />
                <br /><br />
            ...
            HeaderStyle-ForeColor="#3DFF33" CellSpacing="10" CellPadding="12" 
             PagerStyle-CssClass="gridViewPager" PagerStyle-HorizontalAlign="Center" Width="500px" >
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="button" runat="server" Text="View Details" OnClick="gridview1_Click" BorderWidth="0" align="center" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <!--<asp:Label ID="lblu" runat="server" Text="User Details"></asp:Label>-->
