    ...
    public partial class COD : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                /*string q4 = "UPDATE [dbo].[Orders] SET Date=@date WHERE Order_Id=@order_id";
                SqlCommand cmd4 = new SqlCommand(q4, con);
                cmd4.Parameters.AddWithValue("@date", System.DateTime.Now.ToString());
                cmd4.Parameters.AddWithValue("@order_Id", (int)Session["order_id"]);

                cmd4.ExecuteNonQuery();
                */
                //Label1.Text = "delivery1";
