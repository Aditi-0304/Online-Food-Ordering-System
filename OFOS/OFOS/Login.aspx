...
<body>
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="PICS\logo.png" Width="350px"  Height="150px"/>
  <center>      
       <br />
        ...
        <br /><br /><br />
            <center>
                <asp:Button Text="REGISTERED USER" runat="server" Width="232px" OnClick="user_click" 
                    CssClass="b4" CausesValidation="false" />
                <asp:Button Text="GUEST" runat="server" Width="232px" OnClick="guest_click" 
                    CssClass="b4" CausesValidation="false" />
                <br /><br />
       ...
       <table cellpadding="20" style="align-items:center">
         <tr>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="tb_name" ForeColor="Red"  ErrorMessage="Enter your name"></asp:RequiredFieldValidator>
        </td></tr>
        <tr>
        ...
        <tr>
            ...
            <asp:RegularExpressionValidator ID="rev_contact" runat="server" 
                ControlToValidate="tb_contact" Val6dationExpression="[0-9]{10}" ErrorMessage="Please enter upto 10 digits."
                 ForeColor="Red" /></td>
        </tr>
        <tr>
